...
function business:do_action(tbl)
    -- 封装查询条件和排序字段以及分页
    local columns = { "terminal_id", "terminal_name", "device_id", "terminal_sn", "terminal_version", "running_time", "hour_consumption", "consumption", "total_consumption", "stat_time", "create_time", "update_time" }
