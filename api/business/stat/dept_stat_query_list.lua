...
function business:do_action(tbl)
    -- 封装查询条件和排序字段以及分页
    local columns = { "dept_id", "dept_name", "running_time", "hour_consumption", "consumption", "total_consumption", "stat_time as date", "create_time", "update_time" }
    ...
    local table_name = configure.DBCService.DB .. ".t_dept_stat"
